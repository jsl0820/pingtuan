(function(e) {
	...
	var d = require ? require("zepto") : window.$,
		h = d(window),
		c = d('<div class="c-float-popWrap msgMode hide"><div class="c-float-modePop"><div class="warnMsg"></div><div class="content"></div><div class="doBtn"><button class="ok">确认</button><button class="cancel">取消</button></div></div></div>'),
		m = c.find(".warnMsg"),
		n = c.find(".content"),
		o = c.find(".doBtn .ok"),
